...
func (t *RoundTpl) ToGateNormal(pb proto.Message, uids ...uint64) error {
	t.Tlog.Info("send to gate", zap.Any("uids", uids), zap.String("msgName", proto.MessageName(pb)), zap.Any("msgValue", pb))
	// t.Log.Infof(" uids:%v:%s,%+v", uids, proto.MessageName(pb), pb)
	msg := &codec.Message{}
