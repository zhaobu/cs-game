...
func makeDesk(deskArg *pbgame_logic.DeskArg, masterUid, clubMasterUid, deskID uint64, clubID int64, gameNode *tpl.RoomServie) *Desk {
	d := &Desk{deskId: deskID, clubId: clubID, masterUid: masterUid, clubMasterUid: clubMasterUid, deskConfig: deskArg, gameNode: gameNode, RoomLog: &mj.RoomLog{}}
	d.RoomLog.InitLog(gameName, d.deskId, release)
