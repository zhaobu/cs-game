...
func (rcv *Race) MutateCategory(n byte) bool {
...
func RaceAddCategory(builder *flatbuffers.Builder, category byte) {
	builder.PrependByteSlot(21, category, 0)
}
